 ...
 */
class getUserTagRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserTagRepository' shared autowired service.
     *
     * @return \App\Repository\UserTagRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserTagRepository.php';

        return $container->privates['App\\Repository\\UserTagRepository'] = new \App\Repository\UserTagRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
