 ...
 */
class getCalendarTagRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CalendarTagRepository' shared autowired service.
     *
     * @return \App\Repository\CalendarTagRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CalendarTagRepository.php';

        return $container->privates['App\\Repository\\CalendarTagRepository'] = new \App\Repository\CalendarTagRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
