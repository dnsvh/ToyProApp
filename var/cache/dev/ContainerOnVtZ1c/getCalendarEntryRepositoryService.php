 ...
 */
class getCalendarEntryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CalendarEntryRepository' shared autowired service.
     *
     * @return \App\Repository\CalendarEntryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CalendarEntryRepository.php';

        return $container->privates['App\\Repository\\CalendarEntryRepository'] = new \App\Repository\CalendarEntryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
