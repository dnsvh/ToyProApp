 ...
 */
class getDocumentLogRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DocumentLogRepository' shared autowired service.
     *
     * @return \App\Repository\DocumentLogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DocumentLogRepository.php';

        return $container->privates['App\\Repository\\DocumentLogRepository'] = new \App\Repository\DocumentLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
