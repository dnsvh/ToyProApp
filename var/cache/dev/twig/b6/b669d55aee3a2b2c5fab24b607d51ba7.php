...
class __TwigTemplate_5b1b7adcdd0f80e02ddba69bd9900bb9 extends Template
{
    ...
    <a href=\"";
        // line 15
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_calendar_entry_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["calendar_entry"]) || array_key_exists("calendar_entry", $context) ? $context["calendar_entry"] : (function () { throw new RuntimeError('Variable "calendar_entry" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
        yield "\">view</a>
";
    ...
    {
        return array (  124 => 15,  120 => 14,  115 => 12,  110 => 10,  106 => 9,  100 => 7,  87 => 6,  64 => 4,  41 => 2,);
    }
...
{% block title %}Edit Calendar entry{% endblock %}

{% block body %}
    <h1>Edit Calendar entry #{{ calendar_entry.id }}</h1>
    ...
    <a href=\"{{ path('app_calendar_entry_show', { 'id': calendar_entry.id }) }}\">view</a>
{% endblock %}
