...
class __TwigTemplate_e9fa1e6e5ae0b6af4e636fd23c38532e extends Template
{
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_announcement_delete', {'id': announcement.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
